...
def parse_args():
    parser = argparse.ArgumentParser(description="Training a image classification model with transformers, datasets packages.")
    
    parser.add_argument(
        "--dataset_name",
        type=str,
        default="cifar10",
        help="The name of the Dataset (from HuggingFace hub) to train your model.",
    )
    parser.add_argument(
        "--train_dir",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default="./cache",
        help="A folder containing the cache data."
    )
    parser.add_argument(
        "--max_train_samples",
        type=int,
