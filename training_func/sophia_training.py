...
from  from_scratch.models.gpt2 import GPTConfig, GPT2Model as GPT
...
optimizer = model.configure_optimizers_sophia(optimizer_name, weight_decay, learning_rate, (beta1, beta2), rho, device_type)
if init_from == 'resume':
