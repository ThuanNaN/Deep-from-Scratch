...
class SamPredictor:
    ...
    def predict(self,
        ...
        masks, iou_preds, low_res_masks = self.predict_torch(
            coords_torch,
            labels_torch,
            box_torch,
            mask_input_torch,
        ...
        iou_preds_np = iou_preds[0].detach().cpu().numpy()
        low_res_masks_np = low_res_masks[0].detach().cpu().numpy()

        return masks_np, iou_preds_np, low_res_masks_np
    ...
    def predict_torch(self,
        ...
        low_res_masks, iou_preds = self.model.mask_decoder(
            ...
            sparse_prompt_embeds=sparse_embeddings,
            dense_prompt_embeds=dense_embeddings,
